...
label branch3:
    ...
    scene canteen_day with dissolve
...
label b3deca:
    ...
    "Remil, Elena, dan Jeffrey melihat monster"
...
label b3decb:
    ...
    j "Hei kalian"
    #show happy elena as elena di tengah
    show elena_happy as elena_happy
    e "Itu dia!"
    ...
    r " …Terima kasih."
    #show happy jeffrey as jeffry di kanan
    show jeffrey_happy as jeffrey_happy
...
label b3ch2:
    ...
    #show normal elena as elena di tengah
    show elena_normal as elena_sad
...
label b3deca2:
    ...
    show elena_confused as elena_normal
    e "(Uh, masih saja aku tidak mengerti bahasanya)"
    show elena_normal as elena_normal
    #show normal elena as elena di kiri
    ...
    #show suprise elena as elena di kiri
    show elena_surprise as elena_normal
    ...
    #show sad elena as elena di kirivpunch
    show elena_sad as elena_normal
    ...
    r "Apa itu?!"
    #show suprise elena as elena di kiri
    show elena_surprise at enterl1
    e "Pasir…?"
    r "Kenapa dengan pasir?"
    #show serious kai as kai di kanan
    k "Kalian perlu ke *****!"
    #show confuse elena as elena di kiri
    show elena_confused as elena_surprise
    e " …"
    r " …"
    ...
    #show happy elena as elena di tengah
    show elena_happy as elena_normal
    ...
    show elena_nervous as elena_normal
    ...
    show elena_nervous as elena_happy
    ...
    show elena_angry as elena_surprise
    ...
    #show confused elena as elena di tengah
    show elena_confused as elena_happy
    ...
    scene padang_gurun_day with Fade (1.0,1.0,1.0)
    ...
    scene tengah_gurun_day with dissolve
    show elena_confused at enter
    #show confuse elena as elena di tengah
    ...
    #show happy elena as elena di tengah
    show elena_happy as elena_confused
    ...
    #show nervous elena as elena di tengah
    show elena_nervous as elena_confused
...
label b3decb3:
    ...
    #show normal elena as elena di tengah
    show elena_normal as elena_confused
    ...
    #jeffrey manipulativ(?)
    show jeffrey_normal_manipulative as jeffrey_normal
...
label b3ch7:
    ...
    show gordon_smik as gordon_normal
    ...
    show gordon_angry as gordon_normal
    ...
    #show smirk gordon as gordon di tengah
    show gordon_smirk as gordon_normal
    ...
    show gordon_evil-laugh as gordon_normal
